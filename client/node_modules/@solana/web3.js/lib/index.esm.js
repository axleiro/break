...
import { coerce, instance, string, tuple, literal, unknown, union, type, optional, number, boolean, record, nullable, array, create, object, assert } from 'superstruct';
...
class Connection {
  ...
  _wsOnSlotUpdatesNotification(notification) {
    ...
    invariant(typeof res.result !== 'undefined');
...
class Secp256k1Program {
  ...
  static createInstructionWithPublicKey(params) {
    ...
    invariant(publicKey.length === PUBLIC_KEY_BYTES, `Public key must be ${PUBLIC_KEY_BYTES} bytes`);
    let ethPublicKey;
  ...
  static createInstructionWithPrivateKey(params) {
    ...
    invariant(privateKey.length === PRIVATE_KEY_BYTES, `Private key must be ${PRIVATE_KEY_BYTES} bytes`);
